...
const convertHiraganaToKana_1 = require("./util/convertHiraganaToKana");
const config_1 = require("./config");
const findPokemonData_1 = require("./service/findPokemonData");
const formatResponseMessage_1 = require("./service/formatResponseMessage");
const client = new line.Client(config_1.config);
